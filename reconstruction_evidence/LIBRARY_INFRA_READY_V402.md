...
Destino de referencia: carpeta `Elite Franchise Reference V402`, separada de la biblioteca. La ubicación absoluta y los recibos quedan en la guía local `START_REFERENCE_V402.md` del destino.
...
ZIP SHA256: `dba7978d04d08dc2eedb112524708e220ba18cccf86c3a2142f8b1556ed1bf76`. Inventario de artefacto: `b6ed8adea3c569ed8d1086367c7ca7f566282fee39facd53d7c5734d310e508a`. La firma se verificó contra una política pública confiable externa al release; la clave privada permanece protegida fuera del producto.

Para verificar desde PowerShell7:

```powershell
$referencePath = (Resolve-Path '..\Elite Franchise Reference V402').Path
