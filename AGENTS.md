...
4. Salud / wiring / GAPs honestos: `markdown_system/LIBRARY_HEALTH_CHECK.md`.
5. Reconstruir la referencia local: `markdown_system/START_V403_LOCAL.md`.
6. No abras `implementation_packs/UNIFIED_REFERENCE_V403_R4.md` en el contexto. Es el transporte de 2147 fuentes. Materializalo.
7. 48 superficies inventariadas no son 48 aplicaciones ejecutadas. Un PASS local de fixtures no es cloud, CI alojada, dispositivo, proveedor live, aprobación visual ni producción. Los ZIP V402 quedan históricos.
