...
license: "LicenseRef-Workspace-Owner"
sha256: "70acd3af4f68cf1db33b15e5311b9dbf82b2e0ad014e3cf5b0493fb4f8d0ee22"
variables: []
secrets_allowed: false
```
````go
...
func (r *Fiscal) FinishInvoice(ctx context.Context, value fiscal.Invoice, worker string, authorization fiscal.Authorization, eventID string) (fiscal.Invoice, error) {
	codes, err := json.Marshal(authorization.ProviderCodes)
	if err != nil {
		return value, fiscal.ErrInvalid
	}
	tx, err := r.pool.Begin(ctx)
...
source: "local"
license: "LicenseRef-Workspace-Owner"
sha256: "50aad9637ceabb9db2e1c6a5b2b6e3234ad9be0de61ea1b46ce8efb041986c6b"
variables: []
secrets_allowed: false
```
````go
...
func TestFiscalPostgresSourceBindingLeaseReconciliationAndImmutability(t *testing.T) {
	...
	finished, err := repo.FinishInvoice(ctx, claimed, "worker", fiscal.Authorization{Found: true, Authorized: true, CAE: "12345678901234", CAEExpiresOn: &expires, ResponseHash: "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd", ProviderCodes: []string{"RESULT:A"}}, "attempt-finish")
