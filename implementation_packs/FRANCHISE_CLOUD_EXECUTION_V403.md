...
claim: "Complete selected source routing, Linux target composition and bounded cloud control adapters with local fixtures; external runtime, cloud operation and production admission are separate"
